...
require('./models/posts2');
const Users = mongoose.model('Users')
const Posts = mongoose.model('Posts')
const Posts2 = mongoose.model('posts2')
...
const {signUp, addPost,addPost2} = require('./routes/auth') 
...
app.get('/addpost2', requiredAuth, addPost2)

app.post('/addpost2', requiredAuth, (req, res)=>{
    console.log("Addpost2-server")
    ...
    post2.save(function(err, story) {
        if (err) throw err;
        console.log('Post2 added successfully!');
        res.json(story)
    })
})
